            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <select name="launch_status" id="launch_status" class="form-control @error('launch_status') is-invalid @enderror">
                        ...
                        <option value="Available" {{ old('launch_status', $mobile->launch_status ?? '') == 'Available' ? 'selected' : '' }}>Available</option>
                        <option value="Coming soon" {{ old('launch_status', $mobile->launch_status ?? '') == 'Coming soon' ? 'selected' : '' }}>Coming soon</option>
                        <option value="Discontinued" {{ old('launch_status', $mobile->launch_status ?? '') == 'Discontinued' ? 'selected' : '' }}>Discontinued</option>
                    </select>
