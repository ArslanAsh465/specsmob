    ...
    <div class="mb-2">
        ...
        <div class="row d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-3 text-end">
                <a href="{{ route('backend.reviews.create') }}" class="btn btn-sm btn-primary">
    ...
    <div class="shadow-sm rounded bg-white p-3 mt-4">
        <form method="GET" action="{{ route('backend.reviews.index') }}">
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-2">
                    <a href="{{ route('backend.reviews.index') }}" class="btn btn-secondary w-100">Reset</a>
                </div>
            </div>
        </form>
    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-flex justify-content-end align-items-center gap-2">
                                    <a href="{{ route('backend.reviews.show', $item->id) }}" class="text-secondary" title="View">
                                        <i class="bi bi-eye"></i>
                                    </a>

                                    <a href="{{ route('backend.reviews.edit', $item->id) }}" class="text-primary" title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>

                                    <form action="{{ route('backend.reviews.destroy', $item->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function () {
                    ...
                    Swal.fire({
                        title: 'Are you sure?',
                        text: "If you delete this review, all its comments will also be deleted!",
                        icon: 'warning',
