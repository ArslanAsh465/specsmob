...
@section('content')
    ...
    <div class="mb-2">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Mobile Comments</li>
            </ol>
        </nav>
        <div class="row d-flex justify-content-between align-items-center">
            <div class="col-md-9">
                <h1 class="h3 mb-0">Mobile Comments</h1>
            </div>
        </div>
    </div>
    ...
    <div class="shadow-lg rounded bg-white p-3 mt-4">
        <form method="GET" action="{{ route('backend.mobile_comments.index') }}">
            <h5>Filters</h5>
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-2">
                    <a href="{{ route('backend.mobile_comments.index') }}" class="btn btn-secondary w-100">Reset</a>
                </div>
            ...
            <table class="table">
                ...
                <tbody>
                    @forelse($comments as $comment)
                        <tr>
                            <td class="d-none d-lg-table-cell">{{ $comment->mobile->name }}</td>
                            ...
                            <td class="text-end">
                                <div class="d-flex justify-content-end align-items-center gap-2">
                                    <a href="{{ route('backend.mobile_comments.show', $comment->id) }}" class="text-secondary" title="View">
                                        <i class="bi bi-eye"></i>
                                    </a>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center">No mobile comment found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
