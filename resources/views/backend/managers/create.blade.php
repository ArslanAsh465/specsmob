...
@section('content')
    ...
    <div class="mb-2">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <h1 class="h3 mb-0">Add Manager</h1>
        </div>
    </div>

    <!-- Create Manager Form -->
    <div class="shadow-lg rounded bg-white p-3 mt-4">
        <form action="{{ route('backend.managers.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Re-enter password" required>
