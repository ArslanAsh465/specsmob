...
@section('content')
    ...
    <div class="mb-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('backend.news_comments.index') }}" class="text-decoration-none">Comments</a></li>
    ...
    <div class="shadow-lg rounded bg-white p-3 mt-4">
        <div class="row g-3">
            <div class="col-md-6"><strong>News:</strong> {{ $comment->news->title ?? '-' }}</div>
